...
import { PlusCircle, Search, Trash2, CreditCard, UserPlus, PackageSearch, Filter, ShoppingBasket, Percent, Loader2, MinusCircle, Wallet, Mail, MessageSquare, XCircle, UserCheck, UserX, ConciergeBell, CheckCircle, Undo2, Tag, MonitorSmartphone } from "lucide-react";
...
import type { Product, Service, CartItem, Customer, TransactionItem } from "@/types"; 
    ...
    if (userDoc?.storeId) {
      const fetchInitialData = async () => {
        ...
        try {
          ...
          console.error("Error fetching terminal page data:", error);
